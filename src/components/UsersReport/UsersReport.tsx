...
import { getUsersReportAction, IUsersReportRow } from '../../store/usersReport';
...
const UsersReport = (): JSX.Element => {
    ...
    const [rowsState, setRowsState] = useState<IUsersReportRow[]>([]);
    ...
    const ExportButton = () => {
        return (
            <GridToolbarContainer>
                <Workbook
                    filename="Отчет об активности пользователей.xlsx"
                    element={
                        <Button
                            color="primary"
                            variant="contained"
                ...
                >
                    <Workbook.Sheet data={rowsState} name="Отчет по пользователям">
                        <Workbook.Column label="Пользователь" value="fio" />
                        <Workbook.Column label="Ссылка на VK" value="url" />
                        <Workbook.Column label="Количество запросов" value="count" />
                    </Workbook.Sheet>
                </Workbook>
            </GridToolbarContainer>
        );
